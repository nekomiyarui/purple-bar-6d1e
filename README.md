...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/purple-bar-6d1e)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/purple-bar-6d1e
```

A live public deployment of this template is available at [https://purple-bar-6d1e.templates.workers.dev](https://purple-bar-6d1e.templates.workers.dev)
